...
class CWidget(QWidget): 
    ...
    def __init__(self):
        ...
        self.drawExistGcodebtn = QPushButton()
        self.drawExistGcodebtn.setIcon(QIcon(QPixmap("cam.png")))
        self.drawExistGcodebtn.clicked.connect(self.drawExistDlg)
        hbox.addWidget(self.drawExistGcodebtn)
    ...
    def drawExistDlg(self):
        drawExistGcodesender()
        pass 
    ...
    def drawStartDlg(self):
        ...
        self.view.f = open("faceGcode.gcode","w")
        self.view.f.write("G10 P0 L20 X0 Y0 Z0\n")
        self.view.f.write("M3 S30\n")
        self.view.f.write("M3 S10\n")
        self.view.f.write("G90\n")
        self.view.f.write("G21\n")
        pass
